    ...
    <div class="container">
        <div class="row mt-3">
            <form class="offset-sm-4 col-sm-4" action="updateComplete.jsp" method="POST">
                ...
                <input type="text" class="form-control" placeholder="Update product name" name="name">
				
				<input type="text" class="form-control" placeholder="Update description" name="description">
				<input type="number" class="form-control" placeholder="Update unit price" min="1.00" step=".01" name="price">
